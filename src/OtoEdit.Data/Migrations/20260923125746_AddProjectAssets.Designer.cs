...
namespace OtoEdit.Data.Migrations
{
    ...
    [Migration("20260923125746_AddProjectAssets")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OtoEdit.Data.Entities.ChatMessage", b =>
                {
                    ...
                    b.Property<string>("PendingEdlPatch")
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("OtoEdit.Data.Entities.EdlSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ProjectId", "Versiyon")
                        .IsUnique()
                        .HasDatabaseName("idx_edl_snapshots_project_id_versiyon");

                    b.ToTable("edl_snapshots", (string)null);
                });
            ...
            modelBuilder.Entity("OtoEdit.Data.Entities.ProjectAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
